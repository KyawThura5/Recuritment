...
public class TeamSearch {
	...
	public enum Sort {
		...
		TEAM_NAME_SORTING_Z_TO_A("TEAM NAME Z TO A",org.springframework.data.domain.Sort.by("name").descending()),
		TEAM_NAME_SORTING_A_TO_Z("TEAM NAME A TO Z",org.springframework.data.domain.Sort.by("name").ascending())
		;
